...
public class ServiceCoord implements IServiceCoord{
	...
	@Override
	public int updateProgram(TrainingProgram trainingProgram,int x) {
		
		return dao.updateProgram(trainingProgram,x);
	}
	...
	@Override
	public int endDateModification(int cId) throws FMSException {
		// TODO Auto-generated method stub
		return dao.endDateModification(cId);
	}
