...
public class Fmsmain {
	...
	public static void main(String[] args) throws FMSException, ParseException {
                       ...
                       do{
						...
						case 2: {
							...
							do {
								...
								date = kb.nextLine();
								testDate1=Calendar.getInstance();
								testDate1.setTime(df.parse(date));
								b=coord.isValidDate(date);
								days=coord.endDateModification(cId);
